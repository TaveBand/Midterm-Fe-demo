...
function Vocal() {
  ...
  const [boardType, setBoardType] = useState("보컬 게시판 게시글");
  ...
  const handleSubmit = async e => {
    ...
    let newPost;
    if (boardType === String("보컬 게시판 연주영상")) {
      newPost = {
        title,
        link: youtubeLink,
        user_id: "이름",
  ...
  return (
    <div>
      <div className="BoardPage">
        <Header />
        <SessionBtns initialSelectedIndex={2} />
        <div
            ...
            <div className="SessionWriteBoard">
              ...
              <form onSubmit={handleSubmit}>
                <div className="ImgUpload">
                  {boardType === "보컬 게시판 게시글" && imagePreview && (
                    <img src={imagePreview} alt="ImagePreview" width="300px" />
                  )}
                  {boardType === "보컬 게시판 게시글" && (
                    <label>
                      이미지 업로드:
                      <input
                        type="file"
                ...
                <div className="TextUpload">
                  <div>
                    ...
                    <select value={boardType} onChange={handleBoardTypeChange}>
                      <option>보컬 게시판 게시글</option>
                      <option>보컬 게시판 연주영상</option>
                    </select>
                  </div>
